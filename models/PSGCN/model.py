...
class GC_Block(nn.Module):
    ...
    def __init__(self, in_d, p_dropout, bias=True, node_n=48, J=1, part_sep=None, pg=True, W_pg=0.2, W_p=0.5, edge_prob=0.4):
        ...
        self.bn1_conv = nn.Identity() #nn.BatchNorm1d(node_n * in_d)
        self.bn1_scat = nn.Identity() #nn.BatchNorm1d(node_n * in_d)
        ...
        self.bn2_conv = nn.Identity() #nn.BatchNorm1d(node_n * in_d)
...
class GCN(nn.Module):
    def __init__(self, in_d, hid_d, p_dropout, num_stage=1, node_n=48, J=1, part_sep=None, pg=True, W_pg=0.2, W_p=0.2):
        ...
        self.bn1 = nn.Identity() #nn.BatchNorm1d(node_n * hid_d)
